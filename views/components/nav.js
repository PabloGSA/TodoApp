  ...
  navbar.innerHTML = `
      <div class="max-w-7xl h-16 mx-auto flex items-center px-4 justify-between">
        ...
        <svg
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="size-11 md:hidden text-white cursor-pointer py-2 hover:bg-indigo-800 rounded-lg"
        >
          <path
        ...
        <div class="hidden md:flex flex-row gap-4">
          ...
          <a href="/signup/" class="transition ease-in-out text-black font-bold bg-slate-50 hover:bg-slate-200 py-2 px-4 rounded-lg">SignUp</a>
        </div>
...
const createNavLogin = () => {
  navbar.innerHTML = `
      <div class="max-w-7xl h-16 mx-auto flex items-center px-4 justify-between">
        ...
        <!--version escritorio-->
        <div class="hidden md:flex flex-row gap-4">
          <a href="/signup/" class="transition ease-in-out text-white font-bold hover:bg-indigo-800 py-2 px-4 rounded-lg">Signup</a>
        </div>
